      ...
      cartItems.forEach(function(item) {
          ...
          quantity.innerHTML = `
              <div class="cart-btn-container">
                  ...
                  <button class="btn btn-primary cart-btn" data-action="increase" data-index="${cartItems.indexOf(item)}">+</button>
                  <button class="btn btn-primary cart-btn" data-action="decrease" data-index="${cartItems.indexOf(item)}">-</button>
              </div>
          `;
